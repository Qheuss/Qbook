...
const Feed = () => {
  return (
    <section className={styles.quentin}>
      ...
      <Carousel />
      <Post
        text="Ayant récemment terminé la formation Junior Développeur chez BeCode et complété un stage enrichissant chez EVS Broadcast, je suis à la recherche d'une opportunité pour mettre à profit mes compétences dans un environnement professionnel. Éligible au dispositif PFI, je suis ponctuel, dévoué, à l’aise dans les environnements collaboratifs et impatient de contribuer à une équipe tout en continuant à développer mes compétences."
